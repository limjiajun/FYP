...
foreach ($rows as $row) {
    ...
    if (isset($_POST['Update'])) {
        ...
        echo "<script>window.location.replace('profile_A.php')</script>";
        exit;
    }
...
<html lang="en">
  <head>
    ...
    <title>CMS - Manage Profile</title>
    <style>
.grid-container {
  display: grid;
...
<main class="mt-5 pt-3">
    <div class="container">
        <div class="text-center"><b>Profile</b></div>
        <div class="content">
            <form name="profile_A.php" action="profile_A.php" enctype="multipart/form-data" method="post">
                <div class="row">
                    <div class="col-md-6">
