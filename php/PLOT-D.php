  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
         <a class="nav-link" href="PLOT-A.php">Block A</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="PLOT-B.php">Block B</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="PLOT-C.php">Block C</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="PLOT-D.php">Block D</a>
        </li>
      </ul>
    </div>
  </div>
...
while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  ...
  echo '<a href="TestGraveDetails.php?cmid=' . $id . '" class="btn btn-primary" style="text-decoration: none;">' . $id . '</a>';
