            ...
            if ($newPassword !== $confirmPassword) {
                echo "
                    <script>
                        ...
                        window.location.href='ChangePassword_A.php';
                    </script>";
                exit;
            }

            if ($hashedPassword === $currentPassword) {
                $update = "UPDATE user_profile SET Password = :newPassword WHERE user_id = :user_id";
...
<main class="mt-5 pt-3">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form name="frmChange" method="post" action="ChangePassword_A.php" onSubmit="return validatePassword()" class="p-4 bg-light border">
