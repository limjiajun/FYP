...
// require '/home2/jiajunco/public_html/test/PHPMailer/src/Exception.php';
// require '/home2/jiajunco/public_html/test/PHPMailer/src/PHPMailer.php';
// require '/home2/jiajunco/public_html/test/PHPMailer/src/SMTP.php';
...
if (isset($_POST['Register'])) {
    ...
    if (!empty($_FILES['image']['tmp_name'])) {
        ...
        // Default image
        $img_des = "../res/users/useravatar.png";
    }
    ...
    $sqlinsert = "INSERT INTO `user_profile`(`Image`,`First_name`, `Last_name`, `Gender`, `Email`, `Password`, `Phone_Number`, `Home_Address`, ``, `user_type`) 
    VALUES ('$img_des','$First_name','$Last_name','$Gender','$Email','$Password','$Phone_Number','$Home_Address','','$user_type')";
...
<html lang="en">
  ...
  <h5 class="alert-heading">Need a temporary email?</h5>
  <p>Please consider signing up for an account using a temporary email service like <a href="https://temp-mail.org/en/" target="_blank">Temp Mail</a>.</p>
</div>
  ...
  <div class="container">
    ...
    <img class="w3-image" src="https://jiajun0701.com/test/res/users/useravatar.png"  id="preview" style="height:100%;width:100px">
    <input type="file" name="image" id= "image" onchange="previewFile()">                 
</div>
